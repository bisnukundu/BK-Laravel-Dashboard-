...
')
     ...
     *
     */ 
        class WireUiComponent {
                    /**
         * 
         *
         * @static 
         */ 
        public static function resolve($originalComponentName)
        {
                        /** @var \WireUi\WireUiComponentResolver $instance */
                        return $instance->resolve($originalComponentName);
        }
...
namespace  { 
            ...
            class WireUiComponent extends \WireUi\Facades\WireUiComponent {}
