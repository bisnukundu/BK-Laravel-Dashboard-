        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="flex">
                <button class="rounded-md focus:outline-none focus:shadow-outline-purple" @click="toggleTheme"
                    ...
                    <template x-if="dark">
                        <x-icon name="light-bulb" style="solid" class="w-5 h-5" />
                    </template>
                </button>
            </li>
            <!-- Notifications menu -->
            ...
            <li class="relative">
                ...
                <div x-show="isProfileMenuOpen">
                    <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                        ...
                        <li class="flex">
                            <form id="logoutForm" method="POST" class="w-full cursor-pointer"
                                action="{{ route('logout') }}">
                                @csrf
                                <a href="javascript:void()" onclick="document.getElementById('logoutForm').submit();"
